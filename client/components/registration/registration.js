...
import { mainToastId, passwordConfirmError, registerApiUrl, plansApiUrl, registerError, registerSuccess } from "../../constants";
...
export default class Registration extends React.Component {
  ...
  getChoiceForm = () => {
    ...
    return (
      <div>
        <p style={{ "textAlign": "center" }}>{getText(plans_setting.text, language)}</p>
        <div>
          <input
            id="radio0"
            type="radio"
          ...
          <div className="inner">
            ...
            >
              <div className="fieldset">
                ...
                {(plans.length === 0 || (plans.length > 0 && selected_plan !== null)) && (
                  <>
                      ...
                      <>
                        <div className="billing-info">
                          <div className="row country">
                            ...
                            <Select options={countries} value={countrySelected} onChange={this.selectedCountry} />
                          </div>
                          ...
                          <div className="row tax_number">
                            ...
                            <input
                              ...
                              value={tax_number}
                              onChange={this.handleChange}
                              placeholder={getText(input_fields.tax_number.placeholder, language)}
                              pattern={input_fields.tax_number.pattern}
                              title={getText(input_fields.tax_number.pattern_description, language)}
                            />
                          </div>
                        </div>
                      </>
              ...
              {(plans.length === 0 || (plans.length > 0 && selected_plan !== null)) && additional_info_text && (
